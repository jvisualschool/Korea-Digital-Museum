# 🏛️ JDigitalMuseum (한국 문화유산 디지털 갤러리)

**국립중앙박물관의 방대한 소장품을 고해상도로 감상하는 모던 웹 갤러리**

### [🌐 실시간 라이브 데모 (Live Demo)](https://jvibeschool.org/KR_MUSEUM/)

JDigitalMuseum은 국립중앙박물관이 제공하는 공공데이터(Open API)를 활용하여, 한국의 아름다운 문화유산을 누구나 쉽고 직관적으로 탐색할 수 있도록 설계된 웹 애플리케이션입니다. 단순한 검색을 넘어, 큐레이션된 특별전과 심미적인 UI 경험을 제공합니다.
